export default function PageBanner({ title, subtitle }) {
  return (
    <div className="relative -mt-4 flex w-screen mx-[calc(50%-50vw)] flex-col items-center justify-center bg-gradient-to-b from-blue-950 via-blue-950 to-slate-950 px-6 py-8 text-center">
